...
- main:
  ...
  - article:
    ...
    - button "Kommentare ein- oder ausblenden":
      - img
      - text: "0"
    - button "Beitrag reposten":
      - img
      - text: "0"
    - button "Beitrag liken":
      - img
      - text: "0"
    - button "Beitrag teilen":
      - img
    - button "Beitrag speichern":
      - img
    - text: 1 Aufrufe
  - article:
    - button "AK"
  ...
  - article:
    ...
    - button "Beitrag teilen":
      - img
    - button "Aus gespeicherten Beiträgen entfernen" [pressed]:
      - img
    - text: 1 Aufrufe
  - article:
    - button "Ashish":
  ...
  - article:
    ...
    - button "Kommentare ein- oder ausblenden":
      - img
      - text: "0"
    - button "Repost entfernen" [pressed]:
      - img
      - text: "1"
    - button "Beitrag liken":
      - img
    ...
    - button "Aus gespeicherten Beiträgen entfernen" [pressed]:
      - img
    - text: 1 Aufrufe
  - paragraph: Sie sind auf dem neuesten Stand.
  - img
